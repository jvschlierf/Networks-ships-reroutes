...
Model Parameters
"""
#Choose the closure that is to be simulated: Choices are:
# - Dover 
# - Gibraltar
# - Hormuz
# - Malacca
# - Panama
# - Suez
# - Total (all the above combined)

pruning_schedule_single = "Gibraltar"

Ships=10                            #number of ships that are simulated
f_factor=0                          #F factor influences the Foresight ships have which determines how early ships re-route 
...
#Our Schedule (run over 90 days ~ 3 months, we are interested in the behavior shortly before and after the network changes)
# pruning_schedule_batch = ["Dover", "Gibraltar", "Hormuz", "Malacca", "Panama", "Suez", "Total"]
...
# fixed_params = {"distances": distances, "major_ports":origin, "pruning_files": pruning_files, "S": Ships,"pruning_schedule": pruning_schedule_single }
# variable_params = {"f": f_factor_batch, "x": x_factor_batch}
